...
There is no server. No email, token, or answer is transmitted anywhere; the site is a static file
and the bookmarklet runs entirely inside your own tab. Your email is kept in `localStorage` only so
you do not have to retype it.
